        ...
        <div class="login-box">
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    ...
                    <hr>
                    <h6 class="login-box-msg">Sistem Informasi Layanan Aspirasi dan Pengaduan Masyarakat pada DPRD KALSEL</h6>
                    <form action="" method="POST">
                        ...
                        <div class="row text-center">
                            <div class="col-12">
                                <button type="submit" class="btn btn-block bg-purple mb-2" name="log"> Login <i class="fa fa-sign-in-alt"></i></button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
